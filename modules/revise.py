...
class Revise:
    ...
    def revise_learner(self, train_loader, explanations, targets, num_epochs=1):
        ...
        for epoch in range(num_epochs):
            ...
            expl_loader = DataLoader(expl_dataset, batch_size=train_loader.batch_size, shuffle=False)
            ...
            for inputs, targets_batch in tqdm(train_loader, desc="Revising learner"):
                ...
                orig_explanations_batch = orig_explanations_batch.to(self.device)
                ...
                for i in range(inputs.size(0)):
                    ...
                    explanation = inputs[i] * inputs.grad[i]
