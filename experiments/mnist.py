"""
Experiment script for MNIST dataset.

This script runs the LSX experiment on the MNIST dataset.
"""
...
def run_experiment(config_path):
    """
    Run the MNIST experiment with the given configuration.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, default="../configs/mnist_config.py", help="Path to configuration file")
